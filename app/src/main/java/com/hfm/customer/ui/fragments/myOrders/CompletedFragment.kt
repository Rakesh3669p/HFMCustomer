...
import com.hfm.customer.ui.fragments.myOrders.adapter.CompletedAdapter
...
@AndroidEntryPoint
class CompletedFragment : Fragment(), View.OnClickListener {
    private lateinit var binding: FragmentBulkOrdersBinding
    private var currentView: View? = null
    @Inject lateinit var completedAdapter: CompletedAdapter
    ...
    private fun init() {
        with(binding) {
            initRecyclerView(requireContext(),binding.bulkOrdersRv,completedAdapter)
    ...
    private fun setOnClickListener() {
        ...
        completedAdapter.setOnOrderClickListener {
