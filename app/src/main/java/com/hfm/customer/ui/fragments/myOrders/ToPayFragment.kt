...
@AndroidEntryPoint
class ToPayFragment : Fragment(), View.OnClickListener {
    private lateinit var binding: FragmentBulkOrdersBinding
    private var currentView: View? = null
    private val mainViewModel: MainViewModel by viewModels()
    @Inject lateinit var toPayAdapter: ToPayAdapter
    ...
    private fun init() {
        ...
        initRecyclerView(requireContext(),binding.bulkOrdersRv,toPayAdapter)
    ...
    private fun setOnClickListener() {
        ...
        toPayAdapter.setOnOrderClickListener {  }
    }
